...
%         fprintf('found Node at line: %d\n',i);
    ...
    if isempty(b)==0  
        ...
        d=strmatch('Mass',out{1,1}(i+5,:)); % Look for Mass
            if isempty(d)==0
                temp4=textscan(out{1}{i+6},'%f 0 0 0 0 0 ');
                temp5=textscan(out{1}{i+7},'0 %f 0 0 0 0 ');
                temp6=textscan(out{1}{i+8},'0 0 %f 0 0 0 ');
                temp7=textscan(out{1}{i+9},'0 0 0 %f 0 0 ');
                temp8=textscan(out{1}{i+10},'0 0 0 0 %f 0 ');
                temp9=textscan(out{1}{i+11},'0 0 0 0 0 %f ');
